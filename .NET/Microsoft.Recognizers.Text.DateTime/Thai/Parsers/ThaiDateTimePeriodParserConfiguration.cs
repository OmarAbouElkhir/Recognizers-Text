...
{
    public class ThaiDateTimePeriodParserConfiguration : BaseOptionsConfiguration, IDateTimePeriodParserConfiguration
    {
        ...
        public ThaiDateTimePeriodParserConfiguration(ICommonDateTimeParserConfiguration config) : base(config.Options)
        {
            ...
            TimeOfDayRegex = ThaiDateTimeExtractorConfiguration.TimeOfDayRegex;
            ...
            NumberCombinedWithUnitRegex = ThaiDateTimePeriodExtractorConfiguration.TimeNumberCombinedWithUnit;
            UnitRegex = ThaiTimePeriodExtractorConfiguration.TimeUnitRegex;
            PeriodTimeOfDayWithDateRegex = ThaiDateTimePeriodExtractorConfiguration.PeriodTimeOfDayWithDateRegex;
            RelativeTimeUnitRegex = ThaiDateTimePeriodExtractorConfiguration.RelativeTimeUnitRegex;
            RestOfDateTimeRegex = ThaiDateTimePeriodExtractorConfiguration.RestOfDateTimeRegex;
            AmDescRegex = ThaiDateTimePeriodExtractorConfiguration.AmDescRegex;
            PmDescRegex = ThaiDateTimePeriodExtractorConfiguration.PmDescRegex;
            WithinNextPrefixRegex = ThaiDateTimePeriodExtractorConfiguration.WithinNextPrefixRegex;
            PrefixDayRegex = ThaiDateTimePeriodExtractorConfiguration.PrefixDayRegex;
            BeforeRegex = ThaiDateTimePeriodExtractorConfiguration.BeforeRegex;
            AfterRegex = ThaiDateTimePeriodExtractorConfiguration.AfterRegex;
