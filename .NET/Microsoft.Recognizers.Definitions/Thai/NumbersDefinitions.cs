...
namespace Microsoft.Recognizers.Definitions.Thai
{
	...
	public static class NumbersDefinitions
	{
		...
		public const string RoundNumberIntegerRegex = @"(ร้อย|พัน|หมื่น|แสน|ล้าน|สิบล้าน|ร้อยล้าน|พันล้าน|หมื่นล้าน|แสนล้าน|ล้านล้าน)";
		...
		public const string OrdinalSuffixRegex = @"((\d*(1st|2nd|3rd|4th|5th|6th|7th|8th|9th|0th))|(11th|12th))";
		public const string OrdinalNumericRegex = @"(\d{1,3}(\s*,\s*\d{3})*\s*th)";
		public static readonly string OrdinalEnglishRegex = $@"({AllOrdinalRegex})";
		...
		public const string DigitalNumberRegex = @"(ร้อย|พัน|หมื่น|แสน|ล้าน|สิบล้าน|ร้อยล้าน|พันล้าน|หมื่นล้าน|แสนล้าน|ล้านล้าน|โหล)|((?<=\d|\b)(k|K|เค|m|M|g|G|b|B|t|T))";
